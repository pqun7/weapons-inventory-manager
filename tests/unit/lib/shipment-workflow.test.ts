...
import type { ManifestReviewItem } from "@/lib/shipment-manifest"
...
describe("shipment manifest row deletion", () => {
  const review = shipmentToManifestReview({
    ...
    lineItems: [
      { id: "row-1", productType: "weapon", weaponTypeId: "wt", weaponSubtypeId: "st", caliberId: "cal", brandId: "br", modelId: "mdl", storageLocationId: "loc", quantity: 1, purchasePrice: 1, retailPrice: 1, wholesalePrice: 1, retailPriceMode: "auto", wholesalePriceMode: "auto", serialNumbers: ["SN-1"], weaponType: "Rifle", subType: "Semi auto", caliber: "5.5mm", brand: "Hatsan", model: "Flash", additionalCosts: [], received: 0 },
      { id: "row-2", productType: "weapon", weaponTypeId: "wt", weaponSubtypeId: "st", caliberId: "cal", brandId: "br", modelId: "mdl", storageLocationId: "loc", quantity: 1, purchasePrice: 1, retailPrice: 1, wholesalePrice: 1, retailPriceMode: "auto", wholesalePriceMode: "auto", serialNumbers: ["SN-2"], weaponType: "Shotgun", subType: "Pump action", caliber: "12 GA", brand: "Radelli", model: "R-1", additionalCosts: [], received: 0 },
      { id: "row-3", productType: "accessory", weaponTypeId: "", weaponSubtypeId: "", caliberId: "", brandId: "", modelId: "", storageLocationId: "loc", quantity: 2, purchasePrice: 1, retailPrice: 1, wholesalePrice: 1, retailPriceMode: "auto", wholesalePriceMode: "auto", serialNumbers: [], weaponType: "", subType: "", caliber: "", brand: "", model: "Case", additionalCosts: [], received: 0 },
    ],
  })
